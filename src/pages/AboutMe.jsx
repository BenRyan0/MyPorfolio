...
const AboutMe = () => {
  return (
    <div
      id="about"
      className="text-zinc-200 lg:h-screen pt-28 md:pt-20 md:px-5 relative w-full"
    >
      {/* Background grid */}
      <div
        className={cn(
      ...
      {/* Content */}
      <motion.div
        className="md:h-full flex flex-col justify-center items-center relative z-20 pl-7"
