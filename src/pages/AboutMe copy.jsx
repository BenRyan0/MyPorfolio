...
const AboutMe = () => {
  return (
   <div id="about" className=" text-slate-100 h-screen">
         <div className="lg:h-full flex flex-wrap justify-center items-center">
            {/* <h2 className='font-bold text-3xl mt-18 w-full px-26'>About Me</h2> */}
